namespace ClumsyAssistant.Pages
{
    partial class PriceFetchPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.richTextBox1.Text = "1、需要先选择盘点结果表和价格表；\n2、需要确保盘点结果表中包含【物料代码、批号】列\n3、需要确保价格表中包含【物料代码、批号、价格】列";
            // 
            // PriceFetchPage
            // 
